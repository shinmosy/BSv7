...
class Uploader {
    async telegraPh(buffer) {
        ...
        try {
            ...
            const form = createFormData(buffer, "file", ext);
    ...
    async uploadPomf2(buffer) {
        ...
        try {
            ...
            const form = createFormData(buffer, "files[]", ext);
    ...
    async top4top(buffer) {
        ...
        try {
            ...
            const form = createFormData(buffer, "file_0_", ext);
    ...
    async uploadToDiscdn(content) {
        ...
        try {
            ...
            const formData = createFormData(content, "files[0]", ext);
    ...
    async Imgbb(content, exp, key) {
        ...
        try {
            ...
            const formData = createFormData(content, "image", ext);
