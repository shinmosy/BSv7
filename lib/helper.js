...
const API = (name, path = '/', query = {}, apikeyqueryname) => (name in global.APIs ? global.APIs[name] : name) + path + (query || apikeyqueryname ? '?' + new URLSearchParams(Object.entries({
    ...query,
    ...(apikeyqueryname ? {
...
const isReadableStream = (stream) => {
    return (
        ...
        stream !== null &&
        (
            (stream instanceof Readable && typeof stream.pipe === 'function') ||
