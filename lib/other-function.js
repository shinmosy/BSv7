...
async function summarize(input, num) {
    try {
      ...
      const summaryText = input || "You can select the compression level by choosing a percentage on the drop-down menu above the editing text box. You can also copy and paste the text you want to compress from another program over into the editor. Pressing the you will find the summarized text in the text box on the right. Tip: Bookmark this page now.";

      const response = await fetch("https://api.text-summarize.com/summarize?ratio=" + ratio, {
        method: "POST",
