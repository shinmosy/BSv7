...
export class mongoDB {
        ...
        this.delete = {
            collection: async (collectionName) => {
                try {
                    ...
                    console.log(("    MongoDB\n").silly, (">>\n  ").main, chalk.bgGreen.black(`Collection '${collectionName}' deleted successfully`));
                } catch (error) {
                    console.log(("    MongoDB\n").silly, (">>\n  ").main, chalk.bgRed.black(`Error deleting collection '${collectionName}': ${error}`));
                }
            }
        };
    ...
    async read() {
        try {
            ...
            console.log(("    MongoDB\n").silly, (">>\n  ").main, chalk.bgGreen.black('Read successful'));
            return this.data;
        } catch (error) {
            console.log(("    MongoDB\n").silly, (">>\n  ").main, chalk.bgRed.black(`Read error: ${error}`));
        }
    }
    ...
    async write(data) {
        try {
            ...
            console.log(("    MongoDB\n").silly, (">>\n  ").main, chalk.bgGreen.black('Write successful'));
            return savedData;
        } catch (error) {
            console.log(("    MongoDB\n").silly, (">>\n  ").main, chalk.bgRed.black(`Write error: ${error}`));
            throw error;
        }
    }
...
export class mongoDBV2 {
    ...
    logDBState() {
        ...
        const status = this.db.readyState;
        console.log(("    MongoDB\n").silly, (">>\n  ").main, statusMessages[status] || chalk.bgRed.black('Unknown MongoDB state'));
    }
}
