...
const { STATES, Schema, model: _model } = mongoose;
...
export class mongoDB {
    constructor(url, options = defaultOptions) {
        ...
        this.db.readyState === STATES.connecting && console.log(chalk.bgBlue.black('MongoDB connecting...'));
this.db.readyState === STATES.connected && console.log(chalk.bgGreen.black('MongoDB connected'));
this.db.readyState === STATES.disconnecting && console.log(chalk.bgYellow.black('MongoDB disconnecting...'));
this.db.readyState === STATES.disconnected && console.log(chalk.bgRed.black('MongoDB disconnected'));
